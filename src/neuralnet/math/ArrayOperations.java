...
public class ArrayOperations {
     ...
     */
    public static int indexmax(double[] data) {
        int result = 0;
     ...
     */
    public static int indexmin(double[] data) {
        int result = 0;
    ...
    public static double mean(double[] data) {
        return ArrayOperations.sum(data) / (double) data.length;
    }
     ...
     *
     * @param data double[][]  matrix to be converted
     * @return float matrix
     */
     ...
     * @param posStart initial position
     ...
     *
     * @param array matrix with elements
     * @param posStartRow initial row position
     * @param posEndRow final row position
     * @param posStartColumn initial column position
     * @param posEndColumn final column position
     ...
     *
     * @param data ArrayList of ArrayList<Double>
     * @param colIndex columun index
     * @return array with elements of column index
     */
     ...
     *
     * @param array double matrix
     * @param colIndexes vector of columns indexes
     ...
     * @param array double matrix
     * @param indexColumn index column
     * @param shiftValue value
     * @param returnColumn return column
     ...
     *
     * @param array double
     * @param values double array with values to get indexes
     ...
     *
     * @param a vector 1 to be merged
     * @param b vector 2 to be merged
