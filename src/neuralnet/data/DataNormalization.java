...
import neuralnet.math.ArrayOperations;
...
public class DataNormalization {
     ...
     *
     * @param normalizedData data matrix of raw real numbers
     * @param normalizedData data matrix of normalized real numbers
     ...
     *
     * @param normalizedData data vector of raw real numbers
     * @param normalizedData data vector of normalized real numbers
     ...
     * Sets normalization
     *
     * @param nn NeuralDataSet vector
     * @param _zscale zscale value
     */
